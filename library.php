...
<nav id="navbar">
    <div class="container">
        <ul>
            <li><a href="library.php"><img src="images/icons/icons8_High_Importance_48px.png"> REQUESTS</a></li>
    ...
    <div class="container">
            ...
            <script>
                $(function(){
                    ...
                    $(".approve").click(function(){
                        ...
                        $.ajax({
                            type:"post",
                            url:"operations/library_operation.php",
        ...
        <div id="profile">
            <div id="profile">
                ...
                <body>
                <?php
                $sql="SELECT student.id, student.index_no,student.library_request, student.first_name,
			...
			INNER JOIN faculty ON student.faculty_id=faculty.faculty_id WHERE library_request=1";
                ...
                <table class="table" cellpadding="5" cellspacing="8">
                    ...
                    while($employee=mysqli_fetch_assoc($records)){
                        ...
                        $query="SELECT student.id,student.index_no,student.library_request,
                        clearance.is_library_approved FROM student INNER JOIN clearance on
                        student.id=clearance.id WHERE clearance.id='$index' and library_request=1
                        GROUP BY student.id";
                        $query2=mysqli_query($con,$query);
                        $fetch=mysqli_fetch_assoc($query2);
                        if($fetch['library_request']==1 && $fetch['is_library_approved']==NULL){
                            echo "<td>"."<h4 style='color:blue;'>In Possession of a Book</h4>"."</td>"." ";
                        }
                        elseif($fetch['library_request']==1 && $fetch['is_library_approved']==0){
