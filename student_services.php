    ...
    <div class="container">
            ...
            <script>
                $(function(){
                    ...
                    $(".approve").click(function(){
                        ...
                        $.ajax({
                            type:"post",
                            url:"operations/student_service_operation.php",
        ...
        <div id="profile">
            <div id="profile">
                ...
                <body>
                <?php
                $sql="SELECT student.id, student.index_no,student.student_service_request, student.first_name,
			...
			INNER JOIN faculty ON student.faculty_id=faculty.faculty_id WHERE student_service_request=1";
                ...
                <table class="table" cellpadding="5" cellspacing="8">
                    ...
                    while($employee=mysqli_fetch_assoc($records)){
                        ...
                        clearance.is_student_service_approved FROM student INNER JOIN clearance on
                        student.id=clearance.id WHERE clearance.id='$index' and student_service_request=1
                        GROUP BY student.id";
                        $query2=mysqli_query($con,$query);
                        $fetch=mysqli_fetch_assoc($query2);
                        if($fetch['student_service_request']==1 && $fetch['is_student_service_approved']==NULL){
                            echo "<td>"."<h4 style='color:blue;'>Pending</h4>"."</td>"." ";
                        }
                        elseif($fetch['student_service_request']==1 && $fetch['is_student_service_approved']==0){
