...
<nav id="navbar">
    <div class="container">
        <ul>
            <li><a href="src.php"><img src="images/icons/icons8_High_Importance_48px.png"> REQUESTS</a></li>
            <li><a href="src_records.php"><img src="images/icons/icons8_Filing_Cabinet_50px.png"> RECORDS</a></li>
        ...
        <div id="div">
            ...
            <script>
                $(function(){
                    ...
                    $(".approve").click(function(){
                        ...
                        $.ajax({
                            type:"post",
                            url:"operations/src_operation.php",
            ...
            <div id="profile">
                <div id="profile">
                    ...
                    <body>
                    <?php
                    $sql="SELECT student.id, student.index_no,student.src_request, student.first_name,
			...
			INNER JOIN faculty ON student.faculty_id=faculty.faculty_id WHERE src_request=1";
                    ...
                    <table class="table" cellpadding="5" cellspacing="8">
                        ...
                        while($employee=mysqli_fetch_assoc($records)){
                            ...
                            $query="SELECT student.id,student.index_no,student.src_request,
        clearance.is_src_approved FROM student INNER JOIN clearance on
        student.id=clearance.id WHERE clearance.id='$index' and src_request=1
        GROUP BY student.id";
                            $query2=mysqli_query($con,$query);
                            $fetch=mysqli_fetch_assoc($query2);
                            if($fetch['src_request']==1 && $fetch['is_src_approved']==NULL){
                                echo "<td>"."<h4 style='color:blue;'>Owing Dues</h4>"."</td>"." ";
                            }
                            elseif($fetch['src_request']==1 && $fetch['is_src_approved']==0){
